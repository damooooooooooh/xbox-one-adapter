/**
 * Xbox One property type.
 */
'use strict';
const {Property} = require('gateway-addon');

/**
 * XboxOne property type.
 */
class XboxOneProperty extends Property {
  /**
  ...
  setValue(value) {
    ...
    return new Promise((resolve, reject) => {
      super.setCachedValue(value).then((updatedValue) => {
...
module.exports = XboxOneProperty;
